/// SBox refers to a subsitution box (a.k.a a lookup talbe)
/// which maps 8 bit (1 byte, also 1 hex) inputs to 8 bit (1 byte also 1 hex) outputs.
///
/// Inputs and outputs are considered to be polynomials in the Galois Field GF(2^8).
///
/// In AES the SBox is a Rijndael Subsitution Box which AES is based on.
